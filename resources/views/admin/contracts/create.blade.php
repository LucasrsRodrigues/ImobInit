                                        ...
                                        <label class="label">
                                            ...
                                            <select class="select2" name="owner"
                                                ...
                                                @foreach ($lessors->get() as $lessor)
                                                    <option value="{{$lessor->id }}" {{ (old('owner') == $lessor->id ? 'selected' : '')}} >
                                        ...
                                        <label class="label">
                                            ...
                                            <select name="acquirer" class="select2"
                                                ...
                                                @foreach ($lessees->get() as $lessee)
                                                    <option value="{{$lessee->id }}" {{ (old('acquirer') == $lessee->id ? 'selected' : '')}}>
                                    ...
                                    <div class="label_g2">
                                        ...
                                        <label class="label">
                                            ...
                                            <input type="text" name="rent_price" class="mask-money"
                                                placeholder="Valor de Locação" {{old('rent_price' != 'on' ? 'disabled' : '')}} />
                                        </label>
                                    </div>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select name="due_date" class="select2">
                                                <option value="1" {{(old('due_data') == 1 ? 'selected' : '' )}} >1º</option>
                                                <option value="2" {{(old('due_data') == 2 ? 'selected' : '' )}} >2/mês</option>
                                                <option value="3" {{(old('due_data') == 3 ? 'selected' : '' )}} >3/mês</option>
                                                <option value="4" {{(old('due_data') == 4 ? 'selected' : '' )}} >4/mês</option>
                                                <option value="5" {{(old('due_data') == 5 ? 'selected' : '' )}} >5/mês</option>
                                                <option value="6" {{(old('due_data') == 6 ? 'selected' : '' )}} >6/mês</option>
                                                <option value="7" {{(old('due_data') == 7 ? 'selected' : '' )}} >7/mês</option>
                                                <option value="8" {{(old('due_data') == 8 ? 'selected' : '' )}} >8/mês</option>
                                                <option value="9" {{(old('due_data') == 9 ? 'selected' : '' )}} >9/mês</option>
                                                <option value="10" {{(old('due_data') == 10 ? 'selected' : '' )}} >10/mês</option>
                                                <option value="11" {{(old('due_data') == 11 ? 'selected' : '' )}} >11/mês</option>
                                                <option value="12" {{(old('due_data') == 12 ? 'selected' : '' )}} >12/mês</option>
                                                <option value="13" {{(old('due_data') == 13 ? 'selected' : '' )}} >13/mês</option>
                                                <option value="14" {{(old('due_data') == 14 ? 'selected' : '' )}} >14/mês</option>
                                                <option value="15" {{(old('due_data') == 15 ? 'selected' : '' )}} >15/mês</option>
                                                <option value="16" {{(old('due_data') == 16 ? 'selected' : '' )}} >16/mês</option>
                                                <option value="17" {{(old('due_data') == 17 ? 'selected' : '' )}} >17/mês</option>
                                                <option value="18" {{(old('due_data') == 18 ? 'selected' : '' )}} >18/mês</option>
                                                <option value="19" {{(old('due_data') == 19 ? 'selected' : '' )}} >19/mês</option>
                                                <option value="20" {{(old('due_data') == 20 ? 'selected' : '' )}} >20/mês</option>
                                                <option value="21" {{(old('due_data') == 21 ? 'selected' : '' )}} >21/mês</option>
                                                <option value="22" {{(old('due_data') == 22 ? 'selected' : '' )}} >22/mês</option>
                                                <option value="23" {{(old('due_data') == 23 ? 'selected' : '' )}} >23/mês</option>
                                                <option value="24" {{(old('due_data') == 24 ? 'selected' : '' )}} >24/mês</option>
                                                <option value="25" {{(old('due_data') == 25 ? 'selected' : '' )}} >25/mês</option>
                                                <option value="26" {{(old('due_data') == 26 ? 'selected' : '' )}} >26/mês</option>
                                                <option value="27" {{(old('due_data') == 27 ? 'selected' : '' )}} >27/mês</option>
                                                <option value="28" {{(old('due_data') == 28 ? 'selected' : '' )}} >28/mês</option>
                                            </select>
                                        </label>
